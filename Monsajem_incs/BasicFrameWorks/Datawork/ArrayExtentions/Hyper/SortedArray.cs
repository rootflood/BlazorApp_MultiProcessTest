...
{
    public class SortedArray<ArrayType>:
        BaseArray<ArrayType, SortedArray<ArrayType>>
        where ArrayType:IComparable<ArrayType>
    {
        public SortedArray() :
            base(500)
        { }
        public SortedArray(int MinCount = 500) :
            base(MinCount)
        { }
        public SortedArray(ArrayType[] ar, int MinCount = 500) :
            base(ar, MinCount)
        { }
        ...
        public (int Index, ArrayType Value) BinarySearch(ArrayType key, int minNum, int maxNum)
        {
            ...
            return ((minNum + 1) * -1, Value);
        }

        protected override SortedArray<ArrayType> MakeSameNew()
        {
            return new SortedArray<ArrayType>(MinCount);
        }
    }
}

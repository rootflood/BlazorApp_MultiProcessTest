...
namespace WebAssembly.Browser.DOM
{
    ...
    public interface IHTMLInputElement : IHTMLElement
    {
        ...
        string DefaultNodeValue { get; set; }
        [Export("disabled")]
        bool Disabled { get; set; }
        //[Export("files")]
        //FileList Files { get; }
        ...
        string NodeValue { get; set; }
        //[Export("valueAsDate")]
        //Date NodeValueAsDate { get; set; }
        [Export("valueAsNumber")]
        double NodeValueAsNumber { get; set; }
        [Export("vspace")]

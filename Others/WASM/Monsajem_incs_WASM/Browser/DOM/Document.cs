...
namespace WebAssembly.Browser.DOM
{
    ...
    public sealed partial class Document : Node
    {
        ...
        {
            return InvokeMethod<HTMLElementType>("getElementById", elementId);
        }
        public HTMLElement GetElementById(string elementId)
        {
            return GetElementById<HTMLElement>(elementId);
        }
        ...
        {
            return InvokeMethod<Document>("open");
        }
        ...
        [Export("queryCommandNodeValue")]
        public string QueryCommandNodeValue(string commandId)
        {
            return InvokeMethod<string>("queryCommandNodeValue", commandId);
        }

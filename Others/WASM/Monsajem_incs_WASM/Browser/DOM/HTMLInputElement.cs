...
namespace WebAssembly.Browser.DOM
{
    ...
    public sealed class HTMLInputElement : HTMLElement, IHTMLInputElement
    {
        ...
        //[Export("valueAsDate")]
        //public Date NodeValueAsDate { get => GetProperty<Date>("valueAsDate"); set => SetProperty<Date>("valueAsDate", value); }
        [Export("valueAsNumber")]
        public double NodeValueAsNumber { get => GetProperty<double>("valueAsNumber"); set => SetProperty<double>("valueAsNumber", value); }
        [Export("vspace")]

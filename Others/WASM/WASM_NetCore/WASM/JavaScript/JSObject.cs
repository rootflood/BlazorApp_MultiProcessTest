...
namespace System.Runtime.InteropServices.JavaScript
{
    ...
    public class JSObject : AnyRef, IJSObject, IDisposable
    {
        ...
        public JSObject(IntPtr jsHandle, bool ownsHandle) : base(jsHandle, ownsHandle)
        { }

        public JSObject(int jsHandle, bool ownsHandle) : base((IntPtr)jsHandle, ownsHandle)
        { }

        public JSObject(int jsHandle, object rawObj) : base(jsHandle, false)
        {
            RawObject = rawObj;
        }
